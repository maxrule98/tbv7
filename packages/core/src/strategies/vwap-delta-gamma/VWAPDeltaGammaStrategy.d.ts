...
import { MultiTimeframeCache, MultiTimeframeCacheOptions } from "../../data/multiTimeframeCache";
...
export declare class VWAPDeltaGammaStrategy {
    ...
    constructor(config: VWAPDeltaGammaConfig, deps: VWAPDeltaGammaStrategyDependencies);
...
export declare const createVWAPDeltaGammaCache: (clientFetcher: MultiTimeframeCacheOptions["fetcher"], symbol: string, timeframes: string[], maxAgeMs: number) => MultiTimeframeCache;
export declare const loadVWAPDeltaGammaConfig: (configPath?: string) => VWAPDeltaGammaConfig;
